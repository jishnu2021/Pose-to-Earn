      ...
      <ul className="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            ...
            <span className="flex-1 ms-3 whitespace-nowrap">Redeem Point</span>
  ...
  <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <tbody>
      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <td className="px-6 py-4">Push-Ups</td>
      ...
      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        >
          ...
          <div className="ps-3">
            ...
            <div className="font-normal text-gray-500">Day2</div>
          </div>
        </th>
      ...
      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        >
          ...
          <div className="ps-3">
            <div className="font-normal text-gray-500">Task 3</div>
          </div>
        </th>
        <td className="px-6 py-4">Pull-Ups</td>
        <td className="px-6 py-4">
          <div className="flex items-center">
      ...
      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <td className="px-6 py-4">SitUps</td>
        <td className="px-6 py-4">
          <div className="flex items-center">
