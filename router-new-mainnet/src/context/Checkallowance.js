...
const checkAndSetAllowance = async (wallet, tokenAddress, approvalAddress, amount) => {
    console.log("The ans is ",wallet,tokenAddress,approvalAddress,amount)
    ...
    const allowance = await erc20.allowance( await x, approvalAddress);
    console.log("the allowance", allowance)
